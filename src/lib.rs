...
//! ```
//!
//! **Note:** `define!` expands to a bunch of `macro_rules!`, each of which is an alias. When you use `#![export_derive_aliases]`, these macros are tagged with `#[macro_export]` which
